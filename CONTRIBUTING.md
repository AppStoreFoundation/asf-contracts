# Contributing to AppCoins Protocol smart contracts
...
The [issue tracker](https://github.com/AppStoreFoundation/asf-contracts/issues) is
...
> 3. Further steps, etc.
>
> `<url>` - a link to a code snippet experiencing the bug (if necessary).
>
...
Currently AppCoins Team is focusing on implementing the base of the AppCoins protocol, so a new feature migth not be possible to implement by the team, but it's allways possible for external contributors to implement it.
...
changes for real. However, it's possible that `dev` branch code might be deployed on ropsten network.
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/asf-contracts.git
   # Navigate to the newly cloned directory
   cd asf-contracts
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/AppStoreFoundation/asf-contracts.git
   ```
